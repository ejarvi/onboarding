...
var config = {
    ...
    code_uri: 'https://www.ecobee.com',
    access_token_uri: 'https://api.ecobee.com',
    data_model_uri: 'api.ecobee.com'
}
...
module.exports = {
    ...
    onboard: function(name, deviceTypeFilter, successCallback, errorCallback) {
        ...
        console.log('\nPlease enter credentials for the Ecobee API (from ecobee.com):\n');

        var questions = [
            {
                type: 'input',
                name: 'client_id',
                message: 'Ecobee API Client ID: ',
            ...
            },
            {
                type: 'input',
                name: 'client_secret',
                message: 'Ecobee API Client Secret: ',
                validate: function(value) {
                    var pass = !!value;
                    if (pass) {
                        return true;
        ...
        inquirer.prompt(questions, function(answers) {
            console.log('\nThanks! Initiating Ecobee sign-in.');
            ...
            app.get('/success', function(req, res) {
                ...
                // parse response from Ecobee (authorization_code)
                ...
                var postReq = https.request(options, function(postRes) {
                    ...
                    postRes.on('end', function() {
                        ...
                        if (postRes.statusCode != 200) {
                            ...
                            console.log('Signed in to Ecobee!');
